...
@PrepareForTest(fullyQualifiedNames = "com.example.voomacrud.powermockdemo.*")
public class PowerMockitoUnitTest {
    ...
    public void givenFinalMethods_whenUsingPowerMockito_thenCorrect() throws Exception {
        ...
        when(collaborator.helloMethod()).thenReturn("Hello Wilfred!");
        String welcome = collaborator.helloMethod();
        verify(collaborator).helloMethod();
        assertEquals("Hello Wilfred!", welcome);
    }
